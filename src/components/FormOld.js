...
const FormPage = () => {
  ...
  const section1 = [ 
                    ...
                    { question: "Televersé la fiche de réferences interne", value: question5, setValue: setQuestion5, type: "file"},
                    { question: "Televersé la fiche de l'entrevue", value: question3, setValue: setQuestion3, type: "file"},
                    { question: "Televersé la fiche de réferences externe", value: question6, setValue: setQuestion6, type: "file"},
                    { question: "Validation auprès des départements", value: question6, setValue: setQuestion6, type: "checkbox"},
  ...
  const section2 = [ 
    ...
    { question: "Recueuillir les documents nécessaires (CheckVoid, Certificats, etc.)?", value: question6, setValue: setQuestion6, type: "checkbox"},
    { question: "File upload (si nécessaire)", value: question6, setValue: setQuestion6, type: "checkbox"},
    { question: "Est-ce que j'ai recueuilli tout les documents nécessaires afin de finalisé le dossier physique de l'employé?", value: question6, setValue: setQuestion6, type: "checkbox"},
    { question: "Préparation de l'horaire de l'orientation général", value: question6, setValue: setQuestion6, type: "checkbox"},      
    { question: "Ajouté l'acceuil de l'employé dans agenda & invité les gens concerné", value: question6, setValue: setQuestion6, type: "checkbox"},      
    { question: "Date de la completion de l'embauche", value: question6, setValue: setQuestion6, type: "date"},      
                  ];
